...
namespace CombinedFoo;

[BepInDependency(NineSolsAPICore.PluginGUID)]
[BepInPlugin(MyPluginInfo.PLUGIN_GUID, MyPluginInfo.PLUGIN_NAME, MyPluginInfo.PLUGIN_VERSION)]
public class CombinedFoo : BaseUnityPlugin {
    ...
    private void Awake() {
        ...
        harmony = Harmony.CreateAndPatchAll(typeof(CombinedFoo).Assembly);
    ...
    private void LoadAssetBundle() {
        ...
        var assetBundle = AssemblyUtils.GetEmbeddedAssetBundle("CombinedFoo.preloads.bundle");
